...
-   Quarto has seven styles of slide layout which it can use, as shown in this example. However, additional DHSC slide layouts can be manually added in PowerPoint after it has been rendered.
