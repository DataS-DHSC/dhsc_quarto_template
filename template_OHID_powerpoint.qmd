...
-   Quarto has seven slide layout which it can use, as shown in this example. However, all OHID slide layouts can be manually added in PowerPoint after it has been rendered.
