...
To add R code or an R output (see options at https://quarto.org/docs/reference/cells/cells-knitr.html#overview):
...
![Logo](_extensions/govuk/assets/images/govuk-opengraph-image.png)
