...
html_sidebar <- function(selected, names, folder, subnames = NULL) {
  html <- '<html><link rel="stylesheet" href="./_extensions/govuk/GDS.css"><br><br><ul class="app-subnav__section">'
...
drop_down <- function(title, description) {
  html1 <- '<html><link rel="stylesheet" href="./_extensions/govuk/GDS.css"><details class="govuk-details" data-module="govuk-details"><summary class="govuk-details__summary"><span class="govuk-details__summary-text">'
